...
var getTemplate = function getTemplate() {
  ...
  var items = data.map(function (item) {
    return "<li data-id=\"".concat(item.id, "\" data-type=\"item\" class=\"select__item\">").concat(item.value, "</li>");
  });
...
},{"./bundle-url":"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"styles.sass":[function(require,module,exports) {
...
window.s = select;
},{"./Select/Select":"Select/Select.js","./styles.sass":"styles.sass"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "24826" + '/');
